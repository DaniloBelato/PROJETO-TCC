...
Criado manualmente seguindo:

Padrões de camadas

Classes claras e separadas por responsabilidade

DTOs, Services e Exceptions

H2 para teste

✔ Projeto B

Código gerado com apoio de IA (ChatGPT).
Características:
...
IDE IntelliJ mostrando o Projeto A

Código gerado pela IA no Projeto B

Capturas do ChatGPT entregando trechos de código
